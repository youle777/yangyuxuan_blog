...
htmlhelp_basename = 'yangyuxuan_blogdoc'
...
man_pages = [
    (master_doc, 'yangyuxuan_blog', u'yangyuxuan_blog Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'yangyuxuan_blog', u'yangyuxuan_blog Documentation',
     author, u'yangyuxuan_blog', 'One line description of project.',
     'Miscellaneous'),
]
